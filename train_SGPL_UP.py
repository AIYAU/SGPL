...
def train(im_width, im_height, depth):
    ...
    torch.save(feature_encoder.state_dict(),f'./model/UP/UP_feature_encoder_9way_1shot.pkl')
    torch.save(Prototype_network.state_dict(),f'./model/UP/UP_network_9way_1shot.pkl')
